  ...
  return (
    <div>
        <div className=' w-screen h-screen flex justify-center items-center flex-col'>
            <img className=' opacity-90 -z-20 max-w-screen max-h-screen absolute top-12' src="https://github.com/Fardin3202a/vite-project/blob/main/src/assets/MainBg.png?raw=true" alt="" />
            <img className=' -z-10 max-w-[1020px] max-h-[650px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' src="https://github.com/Fardin3202a/vite-project/blob/main/src/assets/Vector.png?raw=true" alt="" />
