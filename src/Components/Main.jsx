  ...
  return (
    <div>
        <div className=' w-screen h-screen flex justify-center items-center flex-col'>
            ...
            <img className=' -z-10 max-w-[1020px] max-h-[650px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' src="/vite-project/src/assets/Vector.png" alt="" />
